    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Signup Tile - DISABLED */}
          <div
            style={{
              background: 'linear-gradient(135deg, rgba(61, 40, 23, 0.3), rgba(74, 50, 32, 0.3))',
              border: '3px solid #5C4A3A',
              borderRadius: '16px',
              padding: '3rem 2rem',
              cursor: 'not-allowed',
          ...
          >
            ...
            <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>✨</div>
            <h2 style={{ color: '#9B8A7A', fontSize: '1.8rem', marginBottom: '0.5rem' }}>Sign Up</h2>
            <p style={{ color: '#9B8A7A' }}>Registration opening soon</p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '2.5rem', color: '#9B8A7A', marginBottom: '1rem' }}>
            Coming Soon
          </h2>
          <p style={{ fontSize: '1.2rem', color: '#9B8A7A', marginBottom: '2rem' }}>
            Public registration will open soon. Contact us for early access.
          </p>
          <button
            disabled
            style={{
